...
public class Say2 implements IClientIncomingPacket
{
	...
	public void run(GameClient client)
	{
		...
		if (player.isChatBanned() && (_text.charAt(0) != '.'))
		{
			...
			{
				player.sendPacket(SystemMessageId.CHATTING_IS_CURRENTLY_PROHIBITED_IF_YOU_TRY_TO_CHAT_BEFORE_THE_PROHIBITION_IS_REMOVED_THE_PROHIBITION_TIME_WILL_INCREASE_EVEN_FURTHER_S1_SEC_OF_PROHIBITION_IS_LEFT);
			}
			return;
		}
